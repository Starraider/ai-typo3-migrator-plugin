...
- [ ] Playwright setup verified inside DDEV (use `typo3-playwright-ddev` when it is missing)
...
- [ ] VRT test files created:
  ...
  - [ ] Footer `.spec.ts`
- [ ] Reviewed baseline screenshots generated with the site-package command path
...
- [ ] The site-package DDEV build produces `Resources/Public/Css/main.css`
