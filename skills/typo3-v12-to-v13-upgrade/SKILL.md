...
- **Content Blocks migration**: [references/content-blocks-0x-to-1x.md](references/content-blocks-0x-to-1x.md) (0.x-to-1.x compatibility changes and preservation checks)
